        ...
        with st.spinner("Ejecutando nuevo motor de liquidación..."):
            ...
            for factura in st.session_state.lote_encontrado_universal:
                ...
                try:
                    ...
                    fecha_desembolso_str = factura.get('fecha_desembolso_factoring') # Corrected field
